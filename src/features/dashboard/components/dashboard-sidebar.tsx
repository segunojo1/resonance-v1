...
import { AudioLines, Headphones, Home, LayoutGrid, LucideIcon, Settings, Volume2 } from "lucide-react";
                ...
                <SidebarMenu>
                    {items.map((item) => (
                        <SidebarMenuItem key={item.title}>
                            ...
                            tooltip={item.title}
                            className="h-9 px-3 py-2 text-[13px] tracking-tight font-medium border border-transparent data-[acive=true]:border-border data-[active=true]:shadow-[0px_1px_1px_0px_rgba(44,54,53,0.03),inset_0px_0px_0px_2px_white]"
                            >
                                {item.url ? (
                                    <Link href={item.url}>
                                        <item.icon />
...
export function DashboardSidebar() {
    ...
    const othersMenuItems: MenuItem[] = [
        ...
        },
        {
            ...
            url: "mailto:olusegunkd2017@gmail.com",
            icon: Headphones
        }
    ];
        ...
        <Sidebar collapsible="icon">
            <SidebarHeader className="flex flex-col gap-4 pt-4">
                <div className="flex items-center  gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
                    <Image src="/globe.svg" alt="resonance" width={40} height={40} className="rounded-sm" />
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <OrganizationSwitcher hidePersonal fallback={
                        ...
                        appearance={{
                            elements: {
                                ...
                                organizationreviewAvatarBox: "size-6! rounded-sm!",
